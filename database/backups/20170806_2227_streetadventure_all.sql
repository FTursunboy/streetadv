...
-- Дамп данных таблицы sa-new-admin.quest_questions: ~23 rows (приблизительно)
...
-- Дамп данных таблицы sa-new-admin.quest_questions_components: ~5 rows (приблизительно)
