...
CREATE TABLE IF NOT EXISTS `quest_hints` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`hintID`)
) ENGINE=InnoDB AUTO_INCREMENT=1128 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=COMPACT;

-- Дамп данных таблицы sa-new-admin.quest_hints: ~4 rows (приблизительно)
...
INSERT INTO `quest_hints` (`hintID`, `questionID`, `points`, `sort_number`, `voice_over`, `created_at`, `updated_at`) VALUES
	(1127, 683, 33323, 1, NULL, '2017-08-08 12:30:49', '2017-08-08 12:30:59');
...
INSERT INTO `quest_questions` (`questionID`, `questID`, `lat`, `lng`, `radius`, `points`, `geoType`, `isAugmentedReality`, `voice_over`, `offline_map_image`, `sort_number`, `created_at`, `updated_at`) VALUES
	(682, 31, NULL, NULL, NULL, 118, 0, 0, NULL, '4e277b67753041ebbf51ce834d708727.png', 2, '2017-08-03 19:16:45', '2017-08-08 10:03:35'),
	(683, 31, NULL, NULL, NULL, 234, 0, 0, NULL, NULL, 1, '2017-08-06 15:43:26', '2017-08-08 10:03:35');
