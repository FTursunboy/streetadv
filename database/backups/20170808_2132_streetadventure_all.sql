...
) ENGINE=InnoDB AUTO_INCREMENT=778 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=COMPACT;

-- Дамп данных таблицы sa-new-admin.quest_answers: ~2 rows (приблизительно)
...
INSERT INTO `quest_answers` (`answerID`, `questionID`, `type`, `coords`, `voice_over`, `sort_number`, `created_at`, `updated_at`) VALUES
	(776, 683, 'text_choice', NULL, NULL, 630, '2017-07-07 14:52:42', '2017-08-08 17:04:57'),
	(777, 682, 'text_input', NULL, NULL, 630, '2017-07-07 14:52:42', '2017-08-07 15:43:49');
...
INSERT INTO `quest_answers_components` (`componentID`, `questID`, `questionID`, `answerID`, `type`, `text`, `right`, `file`, `sort_number`, `created_at`, `updated_at`) VALUES
	(36, 31, 683, 776, 'text_choice', '111', 0, NULL, 1, '2017-08-08 17:18:51', '2017-08-08 17:18:51'),
	(37, 31, 683, 776, 'text_choice', '333', 0, NULL, 2, '2017-08-08 17:18:51', '2017-08-08 17:18:51'),
	(38, 31, 683, 776, 'text_choice', '444', 0, NULL, 3, '2017-08-08 17:18:51', '2017-08-08 17:18:51'),
	(39, 31, 683, 776, 'text_choice', '222', 1, NULL, 4, '2017-08-08 17:18:51', '2017-08-08 17:18:51'),
	(40, 31, 683, 776, 'text_choice', '555', 0, NULL, 5, '2017-08-08 17:18:51', '2017-08-08 17:18:51');
...
INSERT INTO `quest_appearances` (`appearanceID`, `questID`, `question_bg_color`, `question_text_color`, `question_font_size`, `question_font`, `answer_bg_color`, `answer_text_color`, `answer_font_size`, `answer_font`, `hint_bg_color`, `hint_text_color`, `hint_font_size`, `hint_font`, `quest_background_color`, `chat_background_color`, `cell_description_font`, `cell_description_color`, `chat_background_image`, `created_at`, `updated_at`) VALUES
	(11, 31, '0064AD', 'FFFFFF', '18', 'FreeSans', '00B6EE', 'FFFFFF', '17', 'FreeSans', '0064AD', 'FFFFFF', '18', 'FreeSans', 'FFFFFF', 'FFFFFF', 'FreeSans', 'E7E7E7', NULL, '2017-03-19 12:40:48', '2017-08-08 13:52:19'),
...
CREATE TABLE IF NOT EXISTS `quest_hints` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`hintID`)
) ENGINE=InnoDB AUTO_INCREMENT=1129 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=COMPACT;

-- Дамп данных таблицы sa-new-admin.quest_hints: ~1 rows (приблизительно)
...
INSERT INTO `quest_hints` (`hintID`, `questionID`, `points`, `sort_number`, `voice_over`, `created_at`, `updated_at`) VALUES
	(1127, 683, 33323, 2, NULL, '2017-08-08 12:30:49', '2017-08-08 14:38:47'),
	(1128, 683, 333, 1, NULL, '2017-08-08 13:54:48', '2017-08-08 14:38:47');
...
-- Дамп данных таблицы sa-new-admin.quest_hints_components: ~0 rows (приблизительно)
...
INSERT INTO `quest_hints_components` (`componentID`, `questID`, `questionID`, `hintID`, `type`, `description`, `file`, `sort_number`, `created_at`, `updated_at`) VALUES
	(127, 31, 683, 1128, 'file', NULL, 'd9843583cdef35e57a6c204b7ebb4df8.jpg', 2, '2017-08-08 14:32:54', '2017-08-08 14:32:54'),
	(128, 31, 683, 1128, 'description', '333', NULL, 1, '2017-08-08 14:32:54', '2017-08-08 14:32:54');
...
-- Дамп данных таблицы sa-new-admin.quest_questions: ~2 rows (приблизительно)
...
INSERT INTO `quest_questions` (`questionID`, `questID`, `lat`, `lng`, `radius`, `points`, `geoType`, `isAugmentedReality`, `voice_over`, `offline_map_image`, `sort_number`, `created_at`, `updated_at`) VALUES
	(682, 31, NULL, NULL, NULL, 118, 0, 0, NULL, '4e277b67753041ebbf51ce834d708727.png', 1, '2017-08-03 19:16:45', '2017-08-08 13:53:42'),
	(683, 31, NULL, NULL, NULL, 234, 0, 0, NULL, NULL, 2, '2017-08-06 15:43:26', '2017-08-08 13:53:42');
