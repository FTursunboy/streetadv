    ...
    <div class="col-md-11">
        <div class="input-group">
            ...
            <span class="input-group-btn">
                ...
                <button type="button" class="js-answer-right-button btn waves-effect waves-light btn-primary" title="Правильный ответ"><i class="fa fa-thumbs-up fa-lg"></i></button>
            </span>
