<div class="form-group">
    <div class="col-md-11">
        <div class="input-group">
            ...
            <input type="file" name="components[file][<?= $componentsCount; ?>]" class="dropify js-component" data-height="100" data-component="file" data-default-file="<?= isset($component) ? url('uploads/questions/components/' . $component->file) : ''; ?>" data-show-remove="false"/>
